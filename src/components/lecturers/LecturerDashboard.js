...
export class LecturerDashboard extends Component {
						...
						refreshControl={
							...
							<View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', paddingLeft:13,paddingTop:20}}>
								<View style={{flexDirection:'row', flex:1, justifyContent:'flex-start'}}>
									<Text style={styles.smallHeadingText}> Hi, Dr ABC Robert</Text>
								</View>
							</View>
							...
							<View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center'}}>
								...
								<View style={{flexDirection:'row', width:200, flex:1, justifyContent:'flex-start'}}>
									...
									<TouchableOpacity activeOpacity={1} style={styles.bgPurple} onPress={() =>this.props.navigation.navigate('MyProjectStudents')}>
							...
							<View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center'}}>
								...
								<View style={{flexDirection:'row', width:200, flex:1, justifyContent:'flex-start'}}>
									...
									<TouchableOpacity activeOpacity={1} style={styles.bgPurple}  onPress={() =>this.props.navigation.navigate('MyProjectStudents')}>
										<Text style={styles.smallText}>My Project Students </Text>
									</TouchableOpacity>
								</View>
